          ...
          <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)} className="space-y-4">
            ...
            <TabsContent value="transcription" className="space-y-4">
              <Card className="bg-gradient-to-br from-background/90 to-background/60 backdrop-blur-sm border border-galaxy-nova/30 shadow-xl shadow-galaxy-nova/10">
                ...
                <CardContent>
                  <div className="mb-4 text-sm text-foreground/70 flex flex-wrap gap-x-6 gap-y-2">
                    <div>Method: <span className="font-semibold text-galaxy-nova">{transcriptionMethod}</span></div>
                    
                    {captionInfo.language && (
                      <div>Language: <span className="font-semibold text-galaxy-nova">{captionInfo.language}</span></div>
                    )}
                    
                    {captionInfo.isAutoGenerated !== undefined && (
                      <div>Type: <span className="font-semibold text-galaxy-nova">{captionInfo.isAutoGenerated ? 'Auto-generated' : 'Manual'} captions</span></div>
                    )}
                  </div>
