...
const YouTubeAnalysis = () => {
  ...
  const [transcriptionMethod, setTranscriptionMethod] = useState<"standard" | "alternative" | "api" | "gemini">("gemini");
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (id) {
      ...
      setEntities([]);
      setActiveTab("video");
      // Set Gemini as the default method
  ...
  const toggleTranscriptionMethod = () => {
    const methods = ["gemini", "standard", "alternative", "api"] as const;
